...
estudiantes_matematicas = {"Ana", "Carlos", "Elena", "David", "Fernando"}

# 2. Conjunto de estudiantes que cursan física (5 estudiantes)
estudiantes_fisica = {"Carlos", "Elena", "Gabriela", "Héctor", "Isabel"}

# 3. Conjunto de estudiantes que cursan programación (5 estudiantes)
estudiantes_programacion = {"David", "Elena", "Juan", "Laura", "Miguel"}
